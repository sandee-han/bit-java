...
//		basicSearch();
	...
	private static void customSortEx() {
		//	Member 객체의 배열
		Member[] members = {new Member("홍길동"), new Member("고길동"), 
							new Member("임꺽정"), new Member("장길산")};
		System.out.println("원본 배열: " + Arrays.toString(members));
		Arrays.sort(members);
	...
	//	배열의 정렬
	//	기본 정렬은 오름차순(Ascending: 작은 값 -> 큰 값 순서)
	...
	private static void arrayCopy() {
		char src[] = "Java Programming".toCharArray();	//	char 배열로변환
		...
		System.out.println(Arrays.toString(target));	//	보기좋게 출력
