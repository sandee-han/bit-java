...
// 1. 좁은 표현범위 데이터 -> 넓은 표현범위 데이터 (Promotion)
// 2. 넓은 표현범위 데이터 -> 좁은 표현범위 데이터 (Casting)
...
public class CastingEx {
	...
	public static void promotionEx() {
		...
		float f = l; // 4바이트 실수형, 바이트 수는 적지만 표현범위가 float > long
		System.out.println("float: "+ f);
